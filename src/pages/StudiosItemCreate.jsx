...
import {
  Alert, Checkbox, FormControl, FormControlLabel, InputLabel, MenuItem, Select
} from "@mui/material";
import Box from "@mui/material/Box";
import {Link, useNavigate} from "react-router-dom";
import {DateTimePicker} from "@mui/x-date-pickers";

export const StudiosItemCreate = () => {
  ...
  return (<Container maxWidth="xs">
    <div>
      <Box>
        ...
        {isSuccess && <Alert severity="success">Created successfully!</Alert>}
      </Box>
      <Box display="flex" mb={3} mt={3}>
        <Box flexGrow={1}>
          <Typography component="h2" variant="h6" color="primary" gutterBottom>
            Create new studio item
          </Typography>
        </Box>
        <Box>
          <Link to="/">
